...
public class ResultAggregatorTests
{
	...
	public void Aggregates_repeated_runs_with_the_same_protocol_and_workload()
	{
		var runs = new[]
		{
			CreateRun("ws", throughput: 10, deliveryRatio: 0.8, latencyP95: 10, cpuPeak: 20, memoryPeak: 100, cpuAverage: 10),
			CreateRun("ws", throughput: 20, deliveryRatio: 0.6, latencyP95: 30, cpuPeak: 40, memoryPeak: 300, cpuAverage: 20),
			CreateRun("sse", throughput: 5, deliveryRatio: 0.9, latencyP95: 15, cpuPeak: 25, memoryPeak: 150, cpuAverage: 15)
		};
	...
	public void Leaves_server_resource_aggregates_empty_when_samples_are_unavailable()
	{
		var run = CreateRun("lp", throughput: 10, deliveryRatio: 1, latencyP95: 2,
			cpuPeak: 0, memoryPeak: 0, cpuAverage: 0);
